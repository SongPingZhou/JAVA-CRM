...
public class Md5Test {
	...
	public static String strMd5(String str) {
		...
		for(int i=0;i<md5Bytes.length;i++) {
			...
			/*b1668fddb62a99ce97bd37fec860af89
	...
	public static void main(String[] args) {
		String s=new String("12345");//827ccb0eea8a706c4c34a16891f84e7b
									 //3b54e6dbe68e2bed079850650325638a
		System.out.println("原始字符："+s);
		System.out.println("MD5后："+strMd5(s));
		System.out.println("MD5后再加密：" + KL(strMd5(s)));
		System.out.println("解密为MD5后的：" + JM(KL(strMd5(s))));
		System.out.println("解密后："+converMd5(converMd5(s)));
